...
const services = [
  {
    title: "LANDING PAGES",
    description: "Presencia rapida, enfocada en resultados.",
    features: [
  ...
  },
  {
    ...
    description: "Web profesional con estructura solida.",
    features: [
      "Hasta 6 secciones",
  ...
  },
  {
    ...
    description: "Plataformas con backend y logica propia.",
    features: [
      "Autenticación",
      "Base de datos",
      "Panel administrador",
